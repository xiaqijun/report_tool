...
def generate_email_from_report(
    ...
    if owner_emails:
        ...
        if email_rows:
            ...
            section5_html = (
                '<p class="MsoListParagraph" style="margin: 0cm; font-size: 16px; font-family: SimSun, 宋体;">'
                ...
                f'{rows_html}'
                '</tbody></table>'
                '<p class="MsoListParagraph" style="margin: 0cm; font-size: 14px; font-family: SimSun, 宋体;">'
