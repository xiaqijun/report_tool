...
def generate_email_from_report(
    ...
    if owner_emails:
        ...
        if email_rows:
            ...
            section5_html = (
                '<br/>'
                '<p class="MsoListParagraph" style="margin: 12pt 0cm 6pt 61pt; font-size: 16px; font-family: SimSun, 宋体;">'
                ...
                f'{rows_html}'
                '</tbody></table>'
                '<p class="MsoListParagraph" style="margin: 3pt 0cm 0cm 61pt; font-size: 14px; font-family: SimSun, 宋体;">'
