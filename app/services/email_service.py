        ...
        if email_rows:
            ...
            for name, email in email_rows:
                rows_html += (
                    ...
                    f'<p class="MsoNormal" style="margin: auto 0cm; font-size: 16px; font-family: SimSun, 宋体;"><b><span style="font-size: 14px;">{name}</span></b></p>'
                    f'</td>'
                    ...
                    f'<p class="MsoNormal" style="margin: auto 0cm; font-size: 16px; font-family: SimSun, 宋体;"><span style="font-size: 14px;">{email}</span></p>'
                    f'</td>'
                    '</tr>'
                )
            email_list_text = "；".join(e for _, e in email_rows)
            section5_html = (
                '<p class="MsoNormal" style="margin: 0cm 0cm 0cm 57pt; font-size: 16px; font-family: SimSun, 宋体;">'
                ...
                '<p class="MsoNormal" style="margin: auto 0cm; font-size: 16px; font-family: SimSun, 宋体;"><b><span style="font-size: 14px;">责任人</span></b></p>'
                '</td>'
                ...
                '<p class="MsoNormal" style="margin: auto 0cm; font-size: 16px; font-family: SimSun, 宋体;"><b><span style="font-size: 14px;">邮箱</span></b></p>'
                '</td>'
                '</tr>'
                f'{rows_html}'
                '</tbody></table>'
                '<p class="MsoNormal" style="margin: 3pt 0cm 0cm 57pt; font-size: 14px; font-family: SimSun, 宋体;">'
