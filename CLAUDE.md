...
This project is indexed by GitNexus as **report_tool** (1009 symbols, 2667 relationships, 88 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
