...
This project is indexed by GitNexus as **report_tool** (1068 symbols, 2903 relationships, 93 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
